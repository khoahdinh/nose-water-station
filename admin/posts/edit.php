            ...
            <div class="content">
                ...
                <form action="edit.php" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="title_eng" value="<?php echo $title_eng ?? ''; ?>" class="text-input">
                    </div>
                    <div>
                        <label>Body</label>
                    ...
                    <div>
                        ...
                        <textarea id="preview" name="preview" class="text-input"><?php echo isset($preview) ? ($preview) : ''; ?></textarea>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <?php if (!empty($image)) : ?>
                            <div class="current-image-container">
                                <img src="<?php echo BASE_URL . '/assets/images/' . $image; ?>" alt="Current Image">
                            </div>
                        <?php else : ?>
